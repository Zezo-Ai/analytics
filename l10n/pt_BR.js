OC.L10N.register(
    ...
    {
    "Version" : "Versão",
    "Translation error. Possibly wrong ISO code?" : "Erro de tradução. Possivelmente código ISO errado?",
    ...
    "Edit text variables" : "Editar variáveis de texto",
    "Edit file name" : "Editar nome de arquivo",
    "File name" : "Nome de arquivo",
    "Keep the selected path and replace parts of the file name with text variables, for example report_%today%(Y-m-d).csv. The variable is resolved when the data load runs. See the {linkstart}Wiki{linkend}." : "Mantenha o caminho selecionado e substitua partes do nome do arquivo por variáveis de texto, por exemplo, relatório_%today%(Y-m-d).csv. A variável é resolvida quando o carregamento de dados é executado. Consulte o {linkstart}Wiki{linkend}.",
    "Entire table" : "Tabela completa",
    ...
    "Select the share receiver" : "Selecione o destinatário do compartilhamento",
    ...
    "A pivoted table needs fields in Rows, Columns, and Measures." : "Uma tabela dinâmica precisa de campos em Linhas, Colunas e Medidas.",
    ...
    "Own Formular" : "Próprio formulário",
    "Unavailable column" : "Coluna indisponível",
    ...
    "No formula entered" : "Nenhuma formula inserida",
    "No source columns selected" : "Nenhuma coluna de origem selecionada",
    "Add calculated column" : "Adicionar coluna calculada",
    "Edit calculated column" : "Editar coluna calculada",
    "A table column used by this calculation is not available in the selected layout." : "Uma coluna da tabela utilizada neste cálculo não está disponível no leiaute selecionado.",
    "Choose a column" : "Escolha uma coluna",
    "Select a source column to insert its reference into the formula." : "Selecione uma coluna de origem para inserir sua referência na fórmula.",
    "Formula source columns are read from the formula." : "As colunas de origem da fórmula são lidas a partir da fórmula.",
    ...
    "The first source column is divided by all following columns." : "A primeira coluna de origem é dividida por todas as colunas seguintes.",
    "All selected source columns are multiplied." : "Todas as colunas de origem selecionadas são multiplicadas.",
    ...
    "Divide by" : "Dividir por",
    "Factor {position}" : "Fator {position}",
    ...
    "Enter a formula for the calculated column." : "Insira uma fórmula para a coluna calculada.",
    "The formula could not be parsed." : "Não foi possível analisar a fórmula",
    ...
    "No panorama yet" : "Sem panorama ainda",
    "No report yet" : "Sem relatório ainda",
    "Overview" : "Visão geral",
    "Remove from favorites" : "Remover dos favoritos",
    "Add to favorites" : "Adicionar aos favoritos",
    "Scheduled data load" : "Carregamento de dados programado",
    ...
    "choose the content" : "escolha o conteúdo",
    "Show legend" : "Mostrar legenda",
    "Choose a report" : "Escolher um relatório",
    "The selected picture is not available" : "A imagem selecionada não está disponível",
    "Select layout" : "Selecionar leiaute",
    ...
    "Trend" : "Tendência",
    "The report has a technical error" : "O relatório contém um erro técnico",
    "Report" : "Relatório",
    ...
    "The report name is missing" : "O nome do relatório está faltando",
    ...
    "optional" : "opcional",
    "Asset" : "Recurso",
    "Download count" : "Número de downloads",
    "Tag" : "Etiqueta",
    "Count" : "Número",
    ...
    "Select the source columns available to the chart and table." : "Selecione as colunas de origem disponíveis para o gráfico e a tabela.",
    ...
    "Dataset maintenance" : "Manutenção de conjuntos de dados",
    ...
    "Formula" : "Fórmula",
    "Example: (30 * [Quantity]) + ([Price] * -1)" : "Exemplo: (30 * [Quantidade]) + ([Preço] * -1)",
    "Use the displayed column names, fixed numbers, +, -, *, /, parentheses, and ROUND(value, decimals)." : "Use os nomes das colunas exibidos, números fixos, +, -, *, /, parênteses e ROUND(valor, casas decimais).",
    ...
    "Utilize data from multiple sources with ease" : "Utilize dados de várias fontes com facilidade",
    ...
    "Trigger data loads with scripts using the occ command" : "Acione carregamentos de dados com scripts usando o comando occ",
