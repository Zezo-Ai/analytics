OC.L10N.register(
    ...
    "Add custom column" : "Добави колона",
    "Select the required columns.<br>Rearrange the sequence with drag & drop.<br>Remove all selections to reset.<br>Add custom columns including text variables for dates. See the {linkstart}Wiki{linkend}." : "Избери колоните. 1. Промени последователността чрез влачене. 2.Премахни избора от всички за нулиране. 3.Добави нови колони включително текстови променливи за датите. Виж {linkstart} Инструкциите тук. {linkend}",
    "Select file" : "Избор на файл",
    "Share" : "Споделяне",
    "Select the share receiver" : "Избери получателя за споделяния",
    ...
    "Saved" : "Запазено",
    "Data load copied" : "Заредената информация е копирана",
    ...
    "none" : "няма",
    "Flop N" : "Неуспешни Н-на брой",
    "Results can be limited to Top or Flop N. Remaining values may be summarized as \"others\"." : "Резултатите могат да се ограничат то Макс или \"Flop\" Н-на-брой. Остатъкът ще се обобщи под \"други\".",
    "Time aggregation" : "Обединяване по време",
    "summation" : "събиране",
    "average" : "средна стойност",
    "Aggregate daily data into weeks, months, or years" : "Обедини дневните данни в седмици, месеци или години.",
    "Reset table" : "Нулирай таблицата",
    "Table options" : "Опции",
    "Add" : "Добавяне",
    "Remove" : "Премахване",
    ...
    "Sort data ascending or descending" : "Сортирай възходящо/низходящо",
    "Chart options" : "Опции за диаграма",
    "Select the format of the data and how it should be visualized" : "Избери формата на данните и как трябва да се визуализират",
    ...
    "Funnel" : "Фуния",
    "Thresholds" : "Прагове",
    "Drag fields here" : "Постави полетата тук",
    ...
    "choose the content" : "Избери съдържанието",
    "Show legend" : "Покажи легендата",
    "Delete current page" : "Изтрий настоящата страница",
    "All data will be deleted!" : "Всички данни ще бъдат изтрити!",
    "Select the location for the PDF file" : "Избери местоположението за PDF файла",
    "Save to selected folder" : "Запиши в избраната папка",
    "Download" : "Изтегляне",
    "Export as PDF" : "Експорт като PDF",
    "Starting PDF export" : "Започвам PDF експорт",
    "capturing page {pageCount}" : "записвам страница {pageCount}",
    "captured page {pageCount}" : "{pageCount} страници са записани",
    "page {pageCount} added to pdf" : "страница {pageCount} добавена към PDF",
    "creating pdf" : "Създавам PDF",
    "created pdf" : "PDF е създаден",
    ...
    "Incorrect chart options" : "Невалидни настройки на диаграмите",
    "Incorrect data options" : "Невалидни настройки на данните",
    ...
    "You deleted the report {report}" : "Изтрихте доклада {report}",
    "You shared the report {report}" : "Споделихте доклада {report}",
    "shared the report {report} with you" : "сподели доклада {report} с теб",
    "You created a new dataset: {report}" : "Създаде нов набор от данни: {report}",
    "You deleted the dataset {report}" : "Изтри наборът от данни {report}",
    "You shared the dataset {report}" : "Сподели наборът от данни {report}",
    "shared the dataset {report} with you" : "сподели наборът от данни {report} с теб",
    "You created a new panorama: {report}" : "Създаде нова \"Панорама\": {report}",
    "You deleted the panorama {report}" : "Изтри панорамата {report}",
    "You shared the panorama {report}" : "Сподели панорамата {report}",
    "shared the panorama {report} with you" : "сподели панорамата {report} с теб",
    ...
    "Packages" : "Пакети",
    "Issues" : "Проблеми",
    "Pull Requests" : "Заявки за изтегляне",
    "Limit" : "Ограничение",
    "Filter release assets via extension" : "Филтрирайте активите на версията чрез разширение",
    ...
    "Wiki" : "WiKi /уики/",
    "Options" : "Опции",
    "Show top N items and group others together" : "Покажи първите Н на брой реда и групирай останалите заедно",
    "Analysis" : "Анализ",
    "Translate" : "Превод",
    ...
    "Bar - Stacked" : "Линия - Натрупваща се",
    "Bar - Stacked 100%%" : "Линия - Натрупваща се 100%%",
    "Area" : "Област",
    "Area - 100%%" : "Зона - 100%%",
    "Data options" : "Опции за данни",
    "Export" : "Експорт",
    "Update" : "Обновяване",
    "Time dimension" : "Времеви отрязък",
    "Grouping" : "Групиране",
    "Mode" : "Режим",
    ...
    "Context Chat is required" : "Необходимо е да включите \"Context Chat\"",
    "Description" : "Описание",
    "Explain the data and the purpose of the data in a full sentence. This is required for the AI Assistant to understand the raw data for further processing." : "Обяснете данните и целта на данните в пълно изречение. Това е необходимо, за да може ИИ асистентът да разбере суровите данни за по-нататъшна обработка.",
    "Context Chat relevant" : "Context Chat релевантно",
    "Manual index update" : "Ръчно обновяване на индекса",
    ...
    "Severity" : "Сериозност",
    "Coloring in table" : "Оцветяване в таблица",
    "Single value" : "Единична стойност",
    "Table row" : "Табличен ред",
    "Notification for new records" : "Известие за нови записи",
    "Save threshold" : "Запиши праг",
    "Existing thresholds will be evaluated in the order shown below. The order can be changed by drag & drop." : "Съществуващите прагове ще бъдат оценявани в реда, показан по-долу. Редът може да бъде променен чрез плъзгане и пускане.",
    "Selection" : "Избор",
    ...
    "Daily" : "Всеки ден",
    "Daily - End of day" : "Дневно - на края на деня",
    "Daily - Start of day" : "Дневно - началото на деня",
    "Hourly" : "Почасово",
    ...
    "Select how the raw data is structured" : "Изберете как да се структурират \"суровите\" данните",
    "In rows" : "В редове",
    "In columns" : "В колони",
    "Labels" : "Етикети",
    ...
    "Visualize any data with ease" : "Лесно визуализация на всяка информация",
    "Showcase key insights with Panoramas" : "Покажете ключови показатели с \"Panoramas\"",
    "Various chart types, including lines, columns, and doughnuts" : "Различни видове графики, включително линейни, колонни и тип \"поничка\"",
    "Gain a comprehensive view of your data with Nextcloud Dashboard" : "Постигнете всеобхватен поглед над информацията си чрез таблото на Nextcloud.",
    "Interactive tables for deeper analysis" : "Интерактивни таблици за всеобхватни анализи",
    "Set thresholds to highlight exceptions and receive Nextcloud notifications" : "Задайте граници за да подчертаете изключенията и получите Nextcloud известия",
    "Slice and dice your data with precision" : "Направете прецизна разбивка на информацията си",
    "Apply flexible filters, including dynamic date variables" : "Приложете гъвкави филтри, включително динамични променливи",
    "Top N, sorting and time aggregation" : "Първите Н-на брой, сортиране и агрегиране по време",
    "Customize charts with primary and secondary axes" : "Персонализирайте графиките с основни и вторични оси",
    "Mix and match chart types for each data series" : "Групирайте различни типове диаграми за всяка серия от данни",
    "Save default filters for quick access to your preferred views" : "Запазете филтри по подразбиране за бърз достъп до предпочитаните изгледи",
    "Utilize data from multiple sources with ease" : "Използвайте информация от множество източници с лекота",
    "Data is persisted in the database for maximum flexibility and performance" : "Информацията е запаметена в базата данни за максимална гъвкавост и производителност.",
    "Monitor real-time download statistics with GitHub integration" : "Следете статистики за свалянията в реално време чрез инграция от \"GitHub\"",
    "Leverage the JSON data source to pull data from external services" : "Възползвайте се от JSON източник на данни за да получите информация от външни системи и услуги.",
    "Extract data from virtually any website using the HTML-Grabber" : "Извлечете информация от практически всеки уебсайт чрез \"HTML-Grabber\"",
    "Visualize data from internal Nextcloud applications instantly" : "Визуализирайте информация от вътрешни \"Nextcloud\" приложения на мига",
    "Automate your data workflows seamlessly" : "Автоматизирайте потоците от инфомация с лекота",
    "Persist data from any source directly in Nextcloud" : "Запазете информацията от всеки източник директно в \"Nextcloud\"",
    "Utilize timestamps to create historical records" : "Възползвайте се от времевите маркери за да създадете исторически записи",
    "Perform full or incremental delta loads" : "Направете цялостно или поетапно зареждане на данни",
    "Schedule automatic data loads in the background" : "Задайте график за автоматично зареждане на информацията на заден фо",
    "Trigger data loads with scripts using the occ command" : "Използвайте \"occ\" командата за стартиране на скриптове за зареждане на данни",
    "Push data into Analytics effortlessly via the REST API" : "Изпратете с лекота информацията към Анализи (\"Analytics\") чрез \"REST API\"",
