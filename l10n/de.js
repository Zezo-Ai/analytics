OC.L10N.register(
    ...
    "Datasources still loading. Retry" : "Datenquellen werden noch geladen. Erneut versuchen",
    "Data source not available anymore" : "Datenquelle nicht mehr verfügbar",
    "Edit text variables" : "Textvariablen bearbeiten",
    "Edit file name" : "Dateinamen bearbeiten",
    "File name" : "Dateiname",
    "Keep the selected path and replace parts of the file name with text variables, for example report_%today%(Y-m-d).csv. The variable is resolved when the data load runs. See the {linkstart}Wiki{linkend}." : "Den ausgewählten Pfad beibehalten und Teile des Dateinamens durch Textvariablen ersetzen, zum Beispiel report_%today(Y-m-d).csv. Die Variable wird beim Ausführen des Datenladens aufgelöst. Siehe {linkstart}Wiki{linkend}.",
    "Entire table" : "Gesamte Tabelle",
    "Shared views" : "Geteilte Ansichten",
    "Column Picker" : "Spaltenwähler",
    "Parameter missing" : "Parameter fehlt",
    "Custom Column" : "Benutzerdefinierte Spalte",
    ...
    "Datasets cannot be added to favorites" : "Datensätze können nicht zu Favoriten hinzugefügt werden",
    "Settings" : "Einstellungen",
    "Data" : "Daten",
    "Automation" : "Automatisierung",
    "The data load options could not be loaded" : "Die Datenladungsoptionen konnten nicht geladen werden",
    "Data maintenance is not possible for this type of report" : "Datenpflege ist für diese Art von Bericht nicht möglich",
    "Failed to load data loads" : "Datenladungen konnten nicht geladen werden",
    ...
    "Failed to create data load" : "Datenladung konnte nicht erstellt werden",
    "Failed to save data load" : "Datenladung konnte nicht gespeichert werden",
    "Saved" : "Gespeichert",
    "Failed to copy data load" : "Datenladung konnte nicht kopiert werden",
    "Data load copied" : "Datenladung kopiert",
    "Delete data load" : "Datenladung löschen",
    "Are you sure?" : "Bist du sicher?",
    "Failed to delete data load" : "Datenladung konnte nicht gelöscht werden",
    "Data source simulation" : "Datenquelle simulieren",
    "Load started" : "Datenladung gestartet",
    "Failed to run data load" : "Datenladung konnte nicht ausgeführt werden",
    ...
    "Filter" : "Filter",
    "Dynamic text variables can be used to select dates.<br>The selection is written between two % (e.g. %last2months%).<br>Use * and ? as wildcards for contains and not contains filters.<br>Information on available filters and alternative date formats is available in the {linkstart}Wiki{linkend}." : "Zur Auswahl von Daten können dynamische Textvariablen verwendet werden. <br>Die Auswahl wird zwischen zwei % geschrieben (z. B. %letzte2monate%).<br>  \"*\" und \"?\" als Platzhalter für \"enthält\"- und \"enthält nicht\"-Filter verwenden. Informationen zu verfügbaren Filtern und alternativen Datumsformaten befinden sich im {linkstart}Wiki{linkend}.",
    "Top N" : "Top N",
    "none" : "Keine",
    "Flop N" : "Flop N",
    ...
    "A pivoted table needs fields in Rows, Columns, and Measures." : "Eine Pivot-Tabelle benötigt Felder für Zeilen, Spalten und Kennzahlen.",
    "Untitled calculated column" : "Berechnete Spalte ohne Titel",
    "Calculated column" : "Berechnete Spalte",
    "Add" : "Addieren",
    "Subtract" : "Subtrahieren",
    "Multiply" : "Multiplizieren",
    "Divide" : "Dividieren",
    "Percentage" : "Prozentwert",
    "Own Formular" : "Eigene Formel",
    "Unavailable column" : "Nicht verfügbare Spalte",
    ...
    "Add calculated column" : "Berechnete Spalte hinzufügen",
    "Edit calculated column" : "Berechnete Spalte bearbeiten",
    "A table column used by this calculation is not available in the selected layout." : "Eine für diese Berechnung verwendete Tabellenspalte ist im ausgewählten Layout nicht verfügbar.",
    "Choose a column" : "Eine Spalte auswählen",
    "Select a source column to insert its reference into the formula." : "Eine Quellspalte auswählen, um deren Referenz in die Formel einzufügen.",
    "Formula source columns are read from the formula." : "Formelquellspalten werden aus der Formel gelesen.",
    "Select the numerator first and the denominator second." : "Zuerst den Zähler und dann den Nenner auswählen.",
    "The first source column is the base value. All following columns are subtracted from it." : "Die erste Quellspalte ist der Basiswert. Alle folgenden Spalten werden hiervon subtrahiert.",
    "The first source column is divided by all following columns." : "Die erste Quellspalte wird durch alle folgenden Spalten geteilt.",
    "All selected source columns are multiplied." : "Alle ausgewählten Quellspalten werden multipliziert.",
    "Select at least two source columns. Their order is preserved in the calculation." : "Mindestens zwei Quellspalten aus. Die Reihenfolge bleibt bei der Berechnung erhalten.",
    "Up" : "Hoch",
    "Down" : "Runter",
    "Remove" : "Entfernen",
    "Numerator" : "Zähler",
    ...
    "Subtract value" : "Wert subtrahieren",
    "Divide by" : "Teilen durch",
    "Factor {position}" : "Faktor {position}",
    "Source {position}" : "Quelle {position}",
    "Choose a source column first." : "Zuerst eine Quellspalte auswählen.",
    "This source column is already selected." : "Diese Quellspalte ist bereits ausgewählt.",
    "A percentage calculation needs exactly two source columns." : "Eine Prozentberechnung benötigt genau zwei Quellspalten.",
    "Enter a title for the calculated column." : "Einen Titel für die berechnete Spalte eingeben.",
    "Enter a formula for the calculated column." : "Eine Formel für die berechnete Spalte eingeben.",
    "The formula could not be parsed." : "Die Formel konnte nicht analysiert werden.",
    "Select at least two source columns." : "Mindestens zwei Quellspalten auswählen.",
    ...
    "Leaving this report?" : "Diesen Bericht verlassen?",
    ...
    "The panorama is not available anymore" : "Das Panorama ist nicht mehr verfügbar",
    ...
    "Choose a report" : "Einen Bericht auswählen",
    ...
    "Trend" : "Trend",
    "The report has a technical error" : "Der Bericht hat einen technischen Fehler",
    "Report" : "Bericht",
    ...
    "Analytics for Nextcloud" : "Analytics für Nextcloud",
    ...
    "No valid timestamp found in datasource filename" : "Im Dateinamen der Datenquelle wurde kein gültiger Zeitstempel gefunden",
    "File not found: %s" : "Datei nicht gefunden: %s",
    "Total" : "Gesamt",
    "External" : "Extern",
    ...
    "This report was removed or is not shared with you" : "Dieser Bericht wurde entfernt oder wird nicht mit dir geteilt",
    ...
    "Maintain thresholds for notifications" : "Schwellenwerte für Benachrichtigungen beibehalten",
    "Analysis" : "Analyse",
    ...
    "Select the source columns available to the chart and table." : "Die Quellspalten auswählen, die dem Diagramm und der Tabelle zur Verfügung stehen.",
    ...
    "Data Source" : "Datenquelle",
    "Position the available fields to define the structure of the table. For a classic list view, move all fields into rows." : "Die verfügbaren Felder anordnen, um die Struktur der Tabelle zu definieren. Für eine klassische Listenansicht alle Felder in Zeilen verschieben.",
    "Rows" : "Reihen",
    "Columns" : "Spalten",
    "Measures" : "Messwerte",
    ...
    "Formula" : "Formel",
    "Example: (30 * [Quantity]) + ([Price] * -1)" : "Beispiel: (30 * [Menge]) + ([Preis] * -1)",
    "Use the displayed column names, fixed numbers, +, -, *, /, parentheses, and ROUND(value, decimals)." : "Die angezeigten Spaltennamen, festen Zahlen, +, -, *, /, Klammern und ROUND(Wert, Dezimalstellen) verwenden.",
    ...
    "In rows" : "In Reihen",
    "Data series are organized by horizontal rows." : "Datenreihen sind in horizontalen Zeilen organisiert.",
    "In columns" : "In Spalten",
    "Data series are grouped by vertical columns." : "Datenreihen werden in vertikalen Spalten gruppiert.",
    "Timestamps" : "Zeitstempel",
    "Use first column for time-series indexing." : "Die erste Spalte für die Zeitreihenindizierung verwenden.",
    "Labels" : "Beschriftungen",
    "Choose how doughnut chart labels are displayed" : "Auswählen, wie Donut-Diagrammbeschriftungen angezeigt werden",
    "Doughnut label style" : "Donut-Beschriftungsstil",
    ...
    "Gain a comprehensive view of your data with Nextcloud Dashboard" : "Verschaffe dir mit dem Nextcloud Dashboard einen umfassenden Überblick über deine Daten",
    ...
    "Slice and dice your data with precision" : "Präzises Aufteilen deiner Daten",
    ...
    "Save default filters for quick access to your preferred views" : "Standardfilter für den schnellen Zugriff auf deine bevorzugten Ansichten speichern",
    ...
    "Own report" : "Eigener Bericht",
    "Start from scratch and configure all report settings manually." : "Bei Null beginnen und alle Berichtseinstellungen manuell einrichten.",
    "Templates" : "Vorlagen",
    ...
    "Report template (optional)" : "Berichtsvorlage (optional)",
    "Templates provide preconfigured reports for a data source." : "Vorlagen stellen vorkonfigurierte Berichte für eine Datenquelle bereit.",
    ...
    "Visualization is preconfigured by the selected template and cannot be changed in this step." : "Die Visualisierung ist durch die ausgewählte Vorlage vorkonfiguriert und kann in diesem Schritt nicht geändert werden.",
