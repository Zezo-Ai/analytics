OC.L10N.register(
    ...
    "Removing columns will aggregate the key figures.<br>This applies to the chart and table" : "Ao retirar columnas engadiranse os valores clave.<br>Isto aplícase ao gráfico e á táboa",
    "Filter" : "Filtro",
    ...
    "none" : "ningún",
    "Flop N" : "Os N peores",
    "Results can be limited to Top or Flop N. Remaining values may be summarized as \"others\"." : "Os resultados poden limitarse aos N mellores ou peores. Os valores restantes poden resumirse como «outros».",
    "Time aggregation" : "Agregación temporal",
    "summation" : "suma",
    "average" : "media",
    "Aggregate daily data into weeks, months, or years" : "Agregar datos diarios en semanas, meses ou anos",
    ...
    "Sort data ascending or descending" : "Ordenar os datos de xeito ascendente ou descendente",
    ...
    "Leaving this report?" : "Abandonar este informe?",
    ...
    "The report is not available anymore" : "O informe xa non está dispoñíbel",
    ...
    "Report" : "Informe",
    "No template" : "Non hai ningún modelo",
    ...
    "Visualize data in Analytics" : "Ver os datos en Analítica",
    "Total" : "Total",
    "External" : "Externo",
    ...
    "Connect data from different sources in one place and turn it into shareable insights. Analytics lets teams build flexible panoramas, dashboards, and reports with seamless Nextcloud integration.\n\n## Why Analytics\n- **Centralize data**: combine CSV, spreadsheets, APIs, and Nextcloud apps in one place.\n- **Analyze faster**: use charts, tables, filters, and panoramas to explore data quickly.\n- **Share securely**: collaborate with users, groups, or share links with fine-grained access.\n- **Automate updates**: schedule data loads and keep reports current.\n\n#### Features:\n- **Visualization**: panoramas, reports, charts, tables, filters\n- **Data sources**:\n  - CSV, spreadsheets, API, imports, manual entry\n  - External sources: GitHub, website grabber, JSON\n- **Extensible**: register custom data sources from other apps\n- **Storage**: real-time or database\n- **Automation**: scheduled data loads\n- **Functions**: trend calculations, dis-/aggregation\n- **Alerts**: thresholds for notifications and color coding\n- **Integration**: Files, Activity, Notifications, Flow, Dashboard, Search, Smart picker, Translation\n- **AI Assistant**: Context Chat integration" : "Conecte datos de diferentes orixes nun só lugar e convértaos en coñecementos compartíbeis. Analítica permite aos equipos crear panorámicas flexíbeis, taboleiros de control e informes cunha integración fluída de Nextcloud.\n\n## Por que Analítica\n- **Centralizar datos**: combina CSV, follas de cálculo, API e aplicacións Nextcloud nun só lugar.\n- **Facer análises máis rápidas**: use gráficos, táboas, filtros e panorámicas para explorar datos rapidamente.\n- **Compartir de forma segura**: colabore con usuarios, grupos ou comparta ligazóns con acceso detallado.\n- **Automatizar as actualizacións**: programar cargas de datos e manter os informes actualizados.\n\n#### Funcionalidades:\n- **Vista**: panorámicas, informes, gráficos, táboas, filtros\n- **Orixes de datos**:\n  - CSV, follas de cálculo, API, importacións, entrada manual\n  - Orixes externas: GitHub, capturador de sitios web, JSON\n- **Extensíbel**: rexistrar orixes de datos personalizadas doutras aplicacións\n- **Almacenamento**: en tempo real ou base de datos\n- **Automatización**: cargas de datos programadas\n- **Funcións**: cálculos de tendencias, desagregación/agregación\n- **Alertas**: limiares para notificacións e codificación de cores\n- **Integración**: ficheiros, actividade, notificacións, fluxo, taboleiro de control, busca, selector intelixente, tradución\n- **Asistente de IA**: integración con Parola de contexto",
    ...
    "Wiki" : "Wiki",
    "Options" : "Opcións",
    "Show top N items and group others together" : "Amosar os N mellores elementos e agrupar os demais",
    "Maintain thresholds for notifications" : "Manter os limiares para as notificacións",
    "Analysis" : "Análise",
    "Translate" : "Traducir",
    ...
    "Context Chat is required" : "Precisase da Parola de contexto",
    ...
    "Context Chat relevant" : "Parola de contexto relevante",
    ...
    "Severity" : "Gravidade",
    "Coloring in table" : "Colorear na táboa",
    "Single value" : "Valor único",
    "Table row" : "Fila da táboa",
    "Save threshold" : "Gardar o limiar",
    "Notification for new records" : "Notificación de novos rexistros",
    "Existing thresholds will be evaluated in the order shown below. The order can be changed by drag & drop." : "Os limiares existentes avaliaranse na orde que se amosa a seguir. A orde pódese cambiar arrastrando e soltando.",
    "Selection" : "Selección",
    ...
    "Daily" : "A diario",
    "Daily - End of day" : "Diario — Na fin do día",
    "Daily - Start of day" : "Diario —No comezo do día",
    "Hourly" : "Cada hora",
    ...
    "Use column index starting with 0" : "Usar o índice de columnas comezando por 0",
    "Compact visualization" : "Vista compacta",
    ...
    "Timestamps in first column" : "Marca de tempo na primeira columna",
    "One line per timestamp with the series in the columns" : "Unha liña por marca de tempo coa serie nas columnas",
    "Labels" : "Etiquetas",
    "Choose how doughnut chart labels are displayed" : "Escolla como se amosan as etiquetas do gráfico de rosca.",
    "Doughnut label style" : "Estilo de etiqueta de rosca",
    ...
    "Top N, sorting and time aggregation" : "N mellores, ordenación e agregación temporal",
    ...
    "Push data into Analytics effortlessly via the REST API" : "Introduza os datos en Analítica sen esforzo a través da API REST",
    ...
    "Visualization is preconfigured by the selected template and cannot be changed in this step." : "A vista está preconfigurada polo modelo seleccionado e non pode ser modificada neste paso.",
