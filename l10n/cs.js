OC.L10N.register(
    ...
    "Saved" : "Uloženo",
    "Data load copied" : "Načtení dat zkopírováno",
    ...
    "none" : "žádné",
    "Flop N" : "Nejhorších N",
    "Results can be limited to Top or Flop N. Remaining values may be summarized as \"others\"." : "Výsledky je možné omezit na Nejlepších nebo Nejhorších N. Zbývající hodnoty je možné shrnout jako „ostatní“.",
    "Time aggregation" : "Časová agregace",
    "summation" : "sumarizace",
    "average" : "průměr",
    "Aggregate daily data into weeks, months, or years" : "Agregovat denní data do týdnů, měsíců či let",
    ...
    "Subtract value" : "Odečíst hodnotu",
    "Source {position}" : "Zdroj {position}",
    "Sort order" : "Pořadí řazení",
    "Default" : "Výchozí",
    "Ascending" : "Vzestupně",
    "Descending" : "Sestupně",
    "Sort data ascending or descending" : "Řadit data vzestupně nebo sestupně",
    "Chart options" : "Předvolby pro graf",
    "Select the format of the data and how it should be visualized" : "Vyberte formát dat a to, jak má být vizualizován",
    ...
    "Leaving this report?" : "Opustit toto hlášení?",
    ...
    "capturing page {pageCount}" : "zachycování stránky {pageCount}",
    "captured page {pageCount}" : "zachycena stránka {pageCount}",
    "page {pageCount} added to pdf" : "stránka {pageCount} přidána do pdf",
    "creating pdf" : "vytváření pdf",
    "created pdf" : "vytvořeno pdf",
    "The report is not available anymore" : "Hlášení už není k dispozici",
    "Reset zoom" : "Vrátit přiblížení na výchozí úroveň",
    "No data found" : "Nenalezena žádná data",
    "Trend" : "Trend",
    "Aggregation" : "Agregace",
    "Disaggregation" : "Rozdělování",
    "The report has a technical error" : "Výkaz má technickou chybu",
    "Report" : "Výkaz",
    ...
    "Analytics for Nextcloud" : "Analýzy pro Nextcloud",
    ...
    "You deleted the report {report}" : "Smazali jste výkaz {report}",
    "You shared the report {report}" : "Nasdíleli jste výkaz {report}",
    "shared the report {report} with you" : "nasdílel(a) vám výkaz {report}",
    "You created a new dataset: {report}" : "Vytvořili jste novou datovou sadu: {report}",
    "You deleted the dataset {report}" : "Smazali jste datovou sadu {report}",
    "You shared the dataset {report}" : "Nasdíleli jste datovou sadu {report}",
    "shared the dataset {report} with you" : "nasdílel(a) vám datovou sadu {report}",
    "You created a new panorama: {report}" : "Vytvořili jste nové panorama: {report}",
    "You deleted the panorama {report}" : "Smazali jste panorama {report}",
    "You shared the panorama {report}" : "Nasdíleli jste panorama {report}",
    "shared the panorama {report} with you" : "nasdílel(a) vám panorama {report}",
    ...
    "Visualize data in Analytics" : "Vizualizujte data v Analytikách",
    "Total" : "Celkem",
    "External" : "Externí",
    ...
    "Packages" : "Balíčky",
    "Issues" : "Problémy",
    "Pull Requests" : "Požadavky na přetažení",
    "Limit" : "Omezení",
    ...
    "Tag" : "Štítek",
    "Count" : "Počet",
    "Missing or invalid GitHub access token" : "Chybějící nebo neplatný GitHub přístupový token",
    "Rate limit exceeded" : "Limit četnosti překročen",
    ...
    "Description" : "Popis",
    "Explain the data and the purpose of the data in a full sentence. This is required for the AI Assistant to understand the raw data for further processing." : "Vysvětlit data jejich účel v souvětí. Toto je vyžadováno pro to, aby AI asistent rozuměl holým datům pro jejich další zpracování.",
    "Context Chat relevant" : "Relevantní kontextový chat",
    "Manual index update" : "Ruční aktualizace rejstříku",
    ...
    "Severity" : "Závažnost",
    "Coloring in table" : "Obarvování v tabulce",
    ...
    "Existing thresholds will be evaluated in the order shown below. The order can be changed by drag & drop." : "Stávající prahové hodnoty budou vyhodnocovány v níže zobrazeném pořadí. To je možné změnit jejich přetažením.",
    "Selection" : "Výběr",
    ...
    "Close" : "Zavřít",
    "Calculation method" : "Metoda výpočtu",
    "Available columns" : "Sloupce k dispozici",
    "Formula" : "Vzorec",
    ...
    "Labels" : "Štítky",
    "Choose how doughnut chart labels are displayed" : "Zvolte jak budou zobrazovány popisky koblihového grafu",
    "Doughnut label style" : "Styl koblihového štítku",
    ...
    "Visualize any data with ease" : "Snadno vizualizujte libovolná data",
    "Showcase key insights with Panoramas" : "Ukázat příklad klíčových vhledů s Panoramaty",
    "Various chart types, including lines, columns, and doughnuts" : "Různé typy grafů, včetně řádkových, sloupcových a koláčových",
    "Gain a comprehensive view of your data with Nextcloud Dashboard" : "Získejte celkový pohled na svá data pomocí Nextcloud nástěnky",
    "Interactive tables for deeper analysis" : "Interaktivní tabulky pro hlubší analýzu",
    "Set thresholds to highlight exceptions and receive Nextcloud notifications" : "Nastavit prahy a zvýraznit tak výjimky a obdržet upozornění z Nextcloud",
    "Slice and dice your data with precision" : "Precizně rozkouskujte svá data",
    "Apply flexible filters, including dynamic date variables" : "Uplatněte flexibilní filtry, včetně proměnlivých proměnný datumu",
    "Top N, sorting and time aggregation" : "Nej N, řazení a časová agregace",
    "Customize charts with primary and secondary axes" : "Přizpůsobte si grafy s primárními a sekundárními osami",
    "Mix and match chart types for each data series" : "Kombinujte různé typy grafů pro každou ze sad dat",
    "Save default filters for quick access to your preferred views" : "Uložit výchozí filtry pro rychlý přístup k vámi upřednostňovaným pohledům",
    "Utilize data from multiple sources with ease" : "Snadno využívejte data z vícero zdrojů",
    "Data is persisted in the database for maximum flexibility and performance" : "Data jsou trvale uložena v databázi, což poskytuje nejvíce přizpůsobivosti a výkonu",
    "Monitor real-time download statistics with GitHub integration" : "Pomocí napojení na GitHub sledujte statistiky stažení v reálném čase",
    "Leverage the JSON data source to pull data from external services" : "Využijte JSON datový zdroj pro tlačení dat z externích služeb",
    "Extract data from virtually any website using the HTML-Grabber" : "Vytáhněte data z v podstatě libovolné webové stránky pomocí HTML-Grabber",
    "Visualize data from internal Nextcloud applications instantly" : "Na počkání si vizualizujte data z interních Nextcloud aplikací",
    "Automate your data workflows seamlessly" : "Hladce automatizujte své pracovní postupy s daty",
    "Persist data from any source directly in Nextcloud" : "Uchovávejte data z libovolného zdroje přímo v Nextcloud",
    "Utilize timestamps to create historical records" : "Využít časová razítka pro vytváření historických záznamů",
    "Perform full or incremental delta loads" : "Provádět plná nebo přírůstková načtení",
    "Schedule automatic data loads in the background" : "Plánujte automatická načítání dat na pozadí",
    "Trigger data loads with scripts using the occ command" : "Spouštějte načítání dat pomocí skriptů pomocí příkazu occ",
    "Push data into Analytics effortlessly via the REST API" : "Jednoduše zasílejte data do Analýz prostřednictvím REST API",
    ...
    "Own report" : "Vlastní výkaz",
    "Start from scratch and configure all report settings manually." : "Začít od začátku a nastavit veškerá nastavení výkazu ručně.",
    "Templates" : "Šablony",
    ...
    "Report template (optional)" : "Šablona výkazu (volitelné)",
    "Templates provide preconfigured reports for a data source." : "Šablona poskytuje přednastavené výkazy pro datový zdroj.",
    ...
    "Visualization is preconfigured by the selected template and cannot be changed in this step." : "Vizualizace je přednastavená vybranou šablonou a není ji možné v tomto kroku měnit.",
    "No Chart" : "Žádný graf",
